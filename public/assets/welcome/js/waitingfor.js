    ...
    function constructDialog($dialog, settings) {
        ...
        var nonceAttr = settings.nonce === null ? '' : ' nonce="' + settings.nonce + '"',
            elem = $.parseHTML(
                ...
                '<div class="modal-header" style="display: none; text-align: right; direction: rtl;"' + nonceAttr + '></div>' +
                '<div class="modal-body" style="padding: 20px;text-align: right;">' +
                '<div style="margin-bottom: 10px;font-size: 15px;color: #5f6265;">.جاري تفعيل حسابك وتوقيع التطبيق المتجر وقد تستغرق العملية بعض الدقائق استغل وقتك في الاستغفار</div>' +
